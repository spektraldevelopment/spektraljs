...
var h = Spektral.getElement("mainHeader");
h.innerHTML = "Here's some new text. AAAAAAAAAAAAAAAAAAAAAAAAAAAAAAA";

console.log("h is: " + h + " type: " + Spektral.getType(h) + " array: " + Spektral.listArrayElements(h));
